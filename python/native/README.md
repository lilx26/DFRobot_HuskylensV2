...
This library provides a way to drive the HuskyLensV2 under the Raspberry Pi via smbus2 lib

## Installation
This library depends on the smbus2 library, please ensure that smbus2 has been installed via the following cmd before using this library. 

````bash title="smbus2 Install"
pip install smbus2
````
